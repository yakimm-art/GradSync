...
from snowflake.core.api_integration._generated import rest
from snowflake.core.api_integration._generated.configuration import Configuration
from snowflake.core.api_integration._generated.paging import PagedIter
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in snowflake.core._http_requests.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(snowflake.core.api_integration._generated.models, klass)
            ...
            try:
                ...
                if error.status in (405, 501):
                    raise NotImplementedError(
                        "create_or_update is not yet supported for api_integration. Updating api_integration "
                        "objects is not supported yet; use create() for creating a api_integration."
                    )
                raise
