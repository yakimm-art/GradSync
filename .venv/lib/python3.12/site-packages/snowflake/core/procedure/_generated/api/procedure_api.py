...
class ProcedureApi:
    ...
    def create_procedure(
        ...
        **kwargs,
        ...
        r"""Create a procedure  # noqa: E501

        Create a procedure  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.create_procedure(
        ...     database, var_schema, procedure, create_mode, copy_grants, async_req=True
        ... )
        ...
        return self.create_procedure_with_http_info(database, var_schema, procedure, create_mode, copy_grants, **kwargs)
    ...
    def create_procedure_with_http_info(
        ...
        **kwargs,
        ...
        >>> future = api.create_procedure_with_http_info(
        ...     database, var_schema, procedure, create_mode, copy_grants, async_req=True
        ... )
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        ...
        _all_params = ["database", "var_schema", "procedure", "create_mode", "copy_grants"]
        _all_params.extend(
            [
                "async_req",
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method create_procedure")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def call_procedure(
        ...
        async_req: bool = False,
        **kwargs,
    ) -> Union[Iterable[object], Future[Iterable[object]]]: ...
    ...
    def call_procedure(
        ...
        **kwargs,
        ...
        r"""Call a procedure  # noqa: E501

        Call a procedure  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.call_procedure(
        ...     database, var_schema, name_with_args, call_argument_list, async_req=True
        ... )
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        ...
        :param call_argument_list: (required)
        :type call_argument_list: CallArgumentList
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: Union[Iterable[object], Future[Iterable[object]]]
        """
        kwargs["_return_http_data_only"] = True
        return self.call_procedure_with_http_info(database, var_schema, name_with_args, call_argument_list, **kwargs)

    @validate_call
    def call_procedure_with_http_info(
        self,
        database: Annotated[
            str,
            Field(
        ...
        **kwargs,
        ...
        >>> future = api.call_procedure_with_http_info(
        ...     database, var_schema, name_with_args, call_argument_list, async_req=True
        ... )
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: tuple(Union[Iterable[object], Future[Iterable[object]]], status_code(int), headers(HTTPHeaderDict))
        """
        _params = locals()

        _all_params = ["database", "var_schema", "name_with_args", "call_argument_list"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method call_procedure")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def fetch_procedure(
        ...
        async_req: bool = False,
        **kwargs,
    ) -> Union[Procedure, Future[Procedure]]: ...
    ...
    def fetch_procedure(
        ...
        **kwargs,
        ...
        r"""Fetch a procedure  # noqa: E501

        Fetch a procedure  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.fetch_procedure(database, var_schema, name_with_args, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: Union[Procedure, Future[Procedure]]
        """
        kwargs["_return_http_data_only"] = True
        return self.fetch_procedure_with_http_info(database, var_schema, name_with_args, **kwargs)

    @validate_call
    def fetch_procedure_with_http_info(
        self,
        database: Annotated[
            str,
            Field(
        ...
        **kwargs,
        ...
        >>> future = api.fetch_procedure_with_http_info(database, var_schema, name_with_args, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: tuple(Union[Procedure, Future[Procedure]], status_code(int), headers(HTTPHeaderDict))
        """
        _params = locals()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method fetch_procedure")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def list_procedures(
        ...
        async_req: bool = False,
        **kwargs,
    ) -> Union[Iterable[Procedure], Future[Iterable[Procedure]]]: ...
    ...
    def list_procedures(
        ...
        **kwargs,
        ...
        r"""List procedures  # noqa: E501

        List procedures  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.list_procedures(database, var_schema, like, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: Union[Iterable[Procedure], Future[Iterable[Procedure]]]
        """
        kwargs["_return_http_data_only"] = True
        return self.list_procedures_with_http_info(database, var_schema, like, **kwargs)
    ...
    def list_procedures_with_http_info(
        ...
        **kwargs,
        ...
        >>> future = api.list_procedures_with_http_info(database, var_schema, like, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns a Future object representing the execution of the method.
        :rtype: tuple(Union[Iterable[Procedure], Future[Iterable[Procedure]]], status_code(int), headers(HTTPHeaderDict))
        """
        _params = locals()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method list_procedures")
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def delete_procedure(
        ...
        **kwargs,
        ...
        r"""Delete a procedure  # noqa: E501

        Delete a procedure  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> future = api.delete_procedure(database, var_schema, name_with_args, if_exists, async_req=True)
        >>> result = future.result()
        :param database: Identifier (i.e. name) for the database to which the resource belongs. You can use the `/api/v2/databases` GET request to get a list of available databases. (required)
        :type database: str
        :param var_schema: Identifier (i.e. name) for the schema to which the resource belongs. You can use the `/api/v2/databases/{database}/schemas` GET request to get a list of available schemas for the specified database. (required)
        ...
        """
        kwargs["_return_http_data_only"] = True
        return self.delete_procedure_with_http_info(database, var_schema, name_with_args, if_exists, **kwargs)
    ...
    def delete_procedure_with_http_info(
        ...
        **kwargs,
        ...
        >>> future = api.delete_procedure_with_http_info(
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise _APITypeError(f"Got an unexpected keyword argument '{_key}' to method delete_procedure")
            _params[_key] = _val
        del _params["kwargs"]
