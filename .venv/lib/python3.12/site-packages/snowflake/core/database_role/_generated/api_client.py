...
import snowflake.core.database_role._generated.models

from snowflake.core._thread_pool import get_thread_pool
from snowflake.core.database_role._generated import rest
from snowflake.core.database_role._generated.configuration import Configuration
from snowflake.core.database_role._generated.paging import PagedIter
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in snowflake.core._http_requests.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(snowflake.core.database_role._generated.models, klass)
            ...
            try:
                ...
                if error.status in (405, 501):
                    raise NotImplementedError(
                        "create_or_update is not yet supported for database_role. Updating database_role "
                        "objects is not supported yet; use create() for creating a database_role."
                    )
                raise
