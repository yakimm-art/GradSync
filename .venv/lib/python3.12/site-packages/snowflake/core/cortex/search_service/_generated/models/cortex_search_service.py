...
class CortexSearchService(BaseModel):
    """A model object representing the CortexSearchService resource.

    Constructs an object of type CortexSearchService with the provided properties.
    ...
    search_column: Optional[StrictStr] = None
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CortexSearchService:
        """Create an instance of CortexSearchService from a dict."""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CortexSearchService.parse_obj(obj)

        _obj = CortexSearchService.parse_obj(
            {
                "name": obj.get("name"),
...
class CortexSearchServiceModel:
    def __init__(
    ...
    @classmethod
    def _from_model(cls, model) -> CortexSearchServiceModel:
        return CortexSearchServiceModel(
            name=model.name,
    ...
    def to_dict(self):
        """Create a dictionary of the properties from a CortexSearchService.

        This method constructs a dictionary with the key-value entries corresponding to the properties of the CortexSearchService object.
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CortexSearchServiceModel:
        """Create an instance of CortexSearchService from a dict.

        This method constructs a CortexSearchService object from a dictionary with the key-value pairs of its properties.
        ...
        _______
        CortexSearchService
            A CortexSearchService object created using the input dictionary; this will fail if the required properties are missing.
        """
        return cls._from_model(CortexSearchService.from_dict(obj))


CortexSearchService._model_class = CortexSearchServiceModel
