...
class NonStreamingCompleteResponseChoicesInnerMessage(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NonStreamingCompleteResponseChoicesInnerMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NonStreamingCompleteResponseChoicesInnerMessage:
        """Create an instance of NonStreamingCompleteResponseChoicesInnerMessage from a dict."""
        if obj is None:
            return None

        if type(obj) is not dict:
            return NonStreamingCompleteResponseChoicesInnerMessage.parse_obj(obj)
...
class NonStreamingCompleteResponseChoicesInnerMessageModel:
    ...
    @classmethod
    def _from_model(cls, model) -> NonStreamingCompleteResponseChoicesInnerMessageModel:
    ...
    def to_dict(self):
        """Create a dictionary of the properties from a NonStreamingCompleteResponseChoicesInnerMessage.
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NonStreamingCompleteResponseChoicesInnerMessageModel:
        """Create an instance of NonStreamingCompleteResponseChoicesInnerMessage from a dict.
        ...
        """
        return cls._from_model(NonStreamingCompleteResponseChoicesInnerMessage.from_dict(obj))
