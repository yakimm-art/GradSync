...
import snowflake.core.cortex.inference_service._generated.models

from snowflake.core._thread_pool import get_thread_pool
from snowflake.core.cortex.inference_service._generated import rest
from snowflake.core.cortex.inference_service._generated.configuration import Configuration
from snowflake.core.cortex.inference_service._generated.paging import PagedIter
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in snowflake.core._http_requests.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(snowflake.core.cortex.inference_service._generated.models, klass)
            ...
            try:
                ...
                if error.status in (405, 501):
                    raise NotImplementedError(
                        "create_or_update is not yet supported for inference_service. Updating inference_service "
                        "objects is not supported yet; use create() for creating a inference_service."
                    )
                raise
