...
import snowflake.core.iceberg_table._generated.models
...
from snowflake.core.iceberg_table._generated import rest
from snowflake.core.iceberg_table._generated.configuration import Configuration
from snowflake.core.iceberg_table._generated.paging import PagedIter
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in snowflake.core._http_requests.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(snowflake.core.iceberg_table._generated.models, klass)
            ...
            try:
                ...
                if error.status in (405, 501):
                    raise NotImplementedError(
                        "create_or_update is not yet supported for iceberg_table. Updating iceberg_table "
                        "objects is not supported yet; use create() for creating a iceberg_table."
                    )
                raise
