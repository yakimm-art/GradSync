...
class IcebergTableFromIcebergRest(BaseModel):
    """A model object representing the IcebergTableFromIcebergRest resource.

    Constructs an object of type IcebergTableFromIcebergRest with the provided properties.
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IcebergTableFromIcebergRest:
        """Create an instance of IcebergTableFromIcebergRest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IcebergTableFromIcebergRest:
        """Create an instance of IcebergTableFromIcebergRest from a dict."""
        if obj is None:
            return None

        if type(obj) is not dict:
            return IcebergTableFromIcebergRest.parse_obj(obj)

        _obj = IcebergTableFromIcebergRest.parse_obj(
            {
                "name": obj.get("name"),
...
class IcebergTableFromIcebergRestModel:
    def __init__(
        self,
        name: str,
        catalog_table_name: str,
    ...
    def _to_model(self):
        return IcebergTableFromIcebergRest(
            name=self.name,
    ...
    @classmethod
    def _from_model(cls, model) -> IcebergTableFromIcebergRestModel:
        return IcebergTableFromIcebergRestModel(
            name=model.name,
    ...
    def to_dict(self):
        """Create a dictionary of the properties from a IcebergTableFromIcebergRest.

        This method constructs a dictionary with the key-value entries corresponding to the properties of the IcebergTableFromIcebergRest object.
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IcebergTableFromIcebergRestModel:
        """Create an instance of IcebergTableFromIcebergRest from a dict.

        This method constructs a IcebergTableFromIcebergRest object from a dictionary with the key-value pairs of its properties.
        ...
        IcebergTableFromIcebergRest
            A IcebergTableFromIcebergRest object created using the input dictionary; this will fail if the required properties are missing.
        """
        return cls._from_model(IcebergTableFromIcebergRest.from_dict(obj))


IcebergTableFromIcebergRest._model_class = IcebergTableFromIcebergRestModel
