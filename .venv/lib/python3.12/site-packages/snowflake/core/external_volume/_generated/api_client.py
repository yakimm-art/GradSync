...
from snowflake.core.external_volume._generated import rest
from snowflake.core.external_volume._generated.configuration import Configuration
from snowflake.core.external_volume._generated.paging import PagedIter
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in snowflake.core._http_requests.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(snowflake.core.external_volume._generated.models, klass)
            ...
            try:
                ...
                if error.status in (405, 501):
                    raise NotImplementedError(
                        "create_or_update is not yet supported for external_volume. Updating external_volume "
                        "objects is not supported yet; use create() for creating a external_volume."
                    )
                raise
