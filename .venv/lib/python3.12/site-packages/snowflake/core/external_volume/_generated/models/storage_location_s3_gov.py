...
class StorageLocationS3Gov(StorageLocation):
    """A model object representing the StorageLocationS3Gov resource.

    Constructs an object of type StorageLocationS3Gov with the provided properties.
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StorageLocationS3Gov:
    ...
    def to_dict(
        ...
        _dict["storage_provider"] = StorageLocation.get_child_model_discriminator_value("StorageLocationS3Gov")
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StorageLocationS3Gov:
        """Create an instance of StorageLocationS3Gov from a dict."""
        if obj is None:
            return None

        if type(obj) is not dict:
            return StorageLocationS3Gov.parse_obj(obj)

        _obj = StorageLocationS3Gov.parse_obj(
            {
                "name": obj.get("name"),
...
class StorageLocationS3GovModel(StorageLocation):
    def __init__(
        self,
        name: str,
        storage_aws_role_arn: str,
    ...
    @classmethod
    def _from_model(cls, model) -> StorageLocationS3GovModel:
        return StorageLocationS3GovModel(
            name=model.name,
    ...
    def to_dict(self):
        """Create a dictionary of the properties from a StorageLocationS3Gov.

        This method constructs a dictionary with the key-value entries corresponding to the properties of the StorageLocationS3Gov object.
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StorageLocationS3GovModel:
        """Create an instance of StorageLocationS3Gov from a dict.

        This method constructs a StorageLocationS3Gov object from a dictionary with the key-value pairs of its properties.
        ...
        StorageLocationS3Gov
            A StorageLocationS3Gov object created using the input dictionary; this will fail if the required properties are missing.
        """
        return cls._from_model(StorageLocationS3Gov.from_dict(obj))


StorageLocationS3Gov._model_class = StorageLocationS3GovModel
