...
class MessageContentDeltaTextObject(MessageContentDelta):
    ...
    def to_dict(
        ...
        _dict["type"] = MessageContentDelta.get_child_model_discriminator_value("MessageContentDeltaTextObject")
...
class MessageContentDeltaTextObjectModel(MessageContentDelta):
    ...
    def to_dict(self):
        """Create a dictionary of the properties from a MessageContentDeltaTextObject.
