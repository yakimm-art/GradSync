...
from snowflake.core.stream._generated import rest
from snowflake.core.stream._generated.configuration import Configuration
from snowflake.core.stream._generated.paging import PagedIter
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in snowflake.core._http_requests.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(snowflake.core.stream._generated.models, klass)
            ...
            try:
                ...
                if error.status in (405, 501):
                    raise NotImplementedError(
                        "create_or_update is not yet supported for stream. Updating stream "
                        "objects is not supported yet; use create() for creating a stream."
                    )
                raise
