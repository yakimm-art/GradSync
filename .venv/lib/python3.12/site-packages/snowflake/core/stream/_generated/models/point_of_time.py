...
class PointOfTime(BaseModel):
    ...
    def from_json(
        cls, json_str: str
    ) -> Union[PointOfTimeOffset, PointOfTimeStatement, PointOfTimeStream, PointOfTimeTimestamp]:
...
class PointOfTimeModel:
    ...
    def from_dict(
        cls, obj: dict
    ) -> Union[PointOfTimeOffsetModel, PointOfTimeStatementModel, PointOfTimeStreamModel, PointOfTimeTimestampModel]:
        """Create an instance of PointOfTime from a dict.
