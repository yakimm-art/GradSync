...
import snowflake.core.pipe._generated.models
...
from snowflake.core.pipe._generated import rest
from snowflake.core.pipe._generated.configuration import Configuration
from snowflake.core.pipe._generated.paging import PagedIter
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in snowflake.core._http_requests.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(snowflake.core.pipe._generated.models, klass)
            ...
            try:
                ...
                if error.status in (405, 501):
                    raise NotImplementedError(
                        "create_or_update is not yet supported for pipe. Updating pipe "
                        "objects is not supported yet; use create() for creating a pipe."
                    )
                raise
