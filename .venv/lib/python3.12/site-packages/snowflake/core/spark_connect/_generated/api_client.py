...
import snowflake.core.spark_connect._generated.models
...
from snowflake.core.spark_connect._generated import rest
from snowflake.core.spark_connect._generated.configuration import Configuration
from snowflake.core.spark_connect._generated.paging import PagedIter
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in snowflake.core._http_requests.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(snowflake.core.spark_connect._generated.models, klass)
            ...
            try:
                ...
                if error.status in (405, 501):
                    raise NotImplementedError(
                        "create_or_update is not yet supported for spark_connect. Updating spark_connect "
                        "objects is not supported yet; use create() for creating a spark_connect."
                    )
                raise
