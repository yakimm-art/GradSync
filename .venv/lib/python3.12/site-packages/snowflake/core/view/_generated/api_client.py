...
import snowflake.core.view._generated.models
...
from snowflake.core.view._generated import rest
from snowflake.core.view._generated.configuration import Configuration
from snowflake.core.view._generated.paging import PagedIter
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in snowflake.core._http_requests.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(snowflake.core.view._generated.models, klass)
            ...
            try:
                ...
                if error.status in (405, 501):
                    raise NotImplementedError(
                        "create_or_update is not yet supported for view. Updating view "
                        "objects is not supported yet; use create() for creating a view."
                    )
                raise
