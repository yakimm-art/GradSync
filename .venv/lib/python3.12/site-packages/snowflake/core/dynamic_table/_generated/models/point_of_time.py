...
class PointOfTime(BaseModel):
    ...
    Constructs an object of type PointOfTime with the provided properties.
...
class PointOfTimeModel:
    ...
    def to_dict(self):
        """Create a dictionary of the properties from a PointOfTime.

        This method constructs a dictionary with the key-value entries corresponding to the properties of the PointOfTime object.
    ...
    def from_dict(
        cls, obj: dict
    ) -> Union[PointOfTimeOffsetModel, PointOfTimeStatementModel, PointOfTimeTimestampModel]:
        """Create an instance of PointOfTime from a dict.

        This method constructs a PointOfTime object from a dictionary with the key-value pairs of its properties.
        ...
        _______
        PointOfTime
            A PointOfTime object created using the input dictionary; this will fail if the required properties are missing.
        """
