...
from snowflake.core.task._generated.models import *  # noqa: F403


class TaskSchedule(BaseModel):
    """A model object representing the TaskSchedule resource.

    Constructs an object of type TaskSchedule with the provided properties.
...
class TaskScheduleModel:
    ...
    def to_dict(self):
        """Create a dictionary of the properties from a TaskSchedule.

        This method constructs a dictionary with the key-value entries corresponding to the properties of the TaskSchedule object.
    ...
    def from_dict(cls, obj: dict) -> Union[CronScheduleModel, MinutesScheduleModel]:
        ...
        This method constructs a TaskSchedule object from a dictionary with the key-value pairs of its properties.
        ...
        _______
        TaskSchedule
            A TaskSchedule object created using the input dictionary; this will fail if the required properties are missing.
        """
