...
import snowflake.core.network_policy._generated.models
...
from snowflake.core.network_policy._generated import rest
from snowflake.core.network_policy._generated.configuration import Configuration
from snowflake.core.network_policy._generated.paging import PagedIter
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in snowflake.core._http_requests.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(snowflake.core.network_policy._generated.models, klass)
            ...
            try:
                ...
                if error.status in (405, 501):
                    raise NotImplementedError(
                        "create_or_update is not yet supported for network_policy. Updating network_policy "
                        "objects is not supported yet; use create() for creating a network_policy."
                    )
                raise
