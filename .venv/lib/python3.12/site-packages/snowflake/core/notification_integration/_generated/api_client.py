...
from snowflake.core.notification_integration._generated import rest
from snowflake.core.notification_integration._generated.configuration import Configuration
from snowflake.core.notification_integration._generated.paging import PagedIter
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in snowflake.core._http_requests.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(snowflake.core.notification_integration._generated.models, klass)
            ...
            try:
                ...
                if error.status in (405, 501):
                    raise NotImplementedError(
                        "create_or_update is not yet supported for notification_integration. Updating notification_integration "
                        "objects is not supported yet; use create() for creating a notification_integration."
                    )
                raise
